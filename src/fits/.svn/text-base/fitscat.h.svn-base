...
typedef enum {COMPRESS_NONE, COMPRESS_BASEBYTE, COMPRESS_PREVPIX} compresstype;
/*------------------------------- constants ---------------------------------*/
...
typedef struct structcat
  ...
  access_type	access_type1;		/* READ_ONLY or WRITE_ONLY */
  }		catstruct;
...
typedef struct structtab
  ...
  compresstype	compress_type;		/* image compression type */
